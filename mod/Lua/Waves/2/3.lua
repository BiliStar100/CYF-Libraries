...
function Update()
if frame>0 and frame%80==0 then
directionar=dir[math.random(1,4)]
if directionar=="down" then
GravitySlap(directionar)
Cross("Bone4",-Arena.width/2-50,-Arena.height/2,true,-3,"white",2,0)
Cross("Bone4",Arena.width/2+50,-Arena.height/2,true,3,"white",-2,0)
Cross("Bone6",-Arena.width/2-50,Arena.height/2,true,-3,"white",2,0)
Cross("Bone6",Arena.width/2+50,Arena.height/2,true,3,"white",-2,0)
...
GravitySlap(directionar)
Cross("Bone4",-Arena.width/2,Arena.height/2+50,true,-3,"white",0,-2)
Cross("Bone4",-Arena.width/2,-Arena.height/2-50,true,3,"white",0,2)
Cross("Bone6",Arena.width/2,Arena.height/2+50,true,-3,"white",0,-2)
Cross("Bone6",Arena.width/2,-Arena.height/2-50,true,3,"white",-0,2)
